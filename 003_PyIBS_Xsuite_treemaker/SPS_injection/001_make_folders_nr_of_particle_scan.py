...
study_name        = f"SPS_injection_ions_number_of_particles"

# Loop over the following parameters
n_part_s = np.around(np.logspace(np.log10(200), np.log10(10000), 20), 1).astype(int).tolist() # for particles, only include integer value 
n_turns_s = [10000]
IBS_step_s = [5]
