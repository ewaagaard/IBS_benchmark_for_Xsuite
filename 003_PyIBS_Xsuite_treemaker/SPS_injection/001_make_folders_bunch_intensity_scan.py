...
study_name        = f"SPS_injection_ions_bunch_intensity"
...
bunch_intensity_s = np.around(np.logspace(np.log10(3.5e6), np.log10(3.5e12), 20), 1).tolist() # limit logspace to only one decimal point
emit_x_s = [1.2612]
emit_y_s = [0.9081]
sigma_z_s = [0.039]
V0max_s = [1.7]
